...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Modal, TextInput, RefreshControl, Platform } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  calendarBtn: { height: 48, width: 48, borderRadius: 12, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.divider },
});
